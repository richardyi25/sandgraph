...
function main(){
	...
	g.edges.push(new Edge(g.nodes[0], g.nodes[1], 0, 'data', 3, 30, 'green'));
	g.edges.push(new Edge(g.nodes[0], g.nodes[2], 0, 'weight', 10, 30, 'purple'));
	g.edges.push(new Edge(g.nodes[1], g.nodes[2], 0, 5, 10, 30, 'orange'));
